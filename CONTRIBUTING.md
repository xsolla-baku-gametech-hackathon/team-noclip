...
3. **Branch out:** Create a new branch for your work. Try to name it something like:
...
5. **Open a PR:** Once you're done (or if you just want some feedback early on), open a Pull Request to the `main` branch. 
   - Tag the issue in the description (like `Closes #12`).
6. **Get a review:** Tag someone else on the team to look over your code. 
7. **Merge:** After it's approved and looks good, hit merge and delete your branch.
